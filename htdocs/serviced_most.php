			...
			<div class="col-md-9" name="maincontent" id="maincontent">
				...
				<div id="exercise" name="exercise" class="panel panel-info">
					...
					<div class="panel-body">
						...
						<form role="form" name="" action="serviced_most.php" method="GET">
							Age Filter <br>
						...
						if (!empty($_GET['date']) && !empty($_GET['agegroup'])) {
							...
							$bigquery = "SELECT service_id, service_description, customers from ( select service_id, service_description, count(distinct nfc_id) as customers, Team from most_serviced where months<=$date group by  Team, service_id ) as x where Team = '$agegroup' order by customers desc";
						...
						?>
								<h5> Serviced to most customers sorted by age group:</h5><br>
								<table width="90%" class="table table-hover">
									...
									?>
										<tr>
											<td><?php echo $rekod['customers'] ?></td>
